...
<head>
    ...
    <!-- Ruta dinámica para CSS -->
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/style.css">
</head>
<body>
    <header>
        <div class="container_log">
            <img src="img/logo.png" alt="Logo centrado">
        </div>
        <div class="mini_header">
            <nav>
                <ul>
                    ...
                    <li class="dropdown">
                        <a href="Mujer.jsp">Mujer</a>
                        <ul class="dropdown-menu">
                            <li><a href="#">Zapatillas Casual</a></li>
                            <li><a href="#">Zapatillas Deportivas</a></li>
                            <li><a href="#">Zapatillas de Correr</a></li>
                            <li><a href="#">Botas</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="Hombre.jsp">Hombre</a>
                        <ul class="dropdown-menu">
                            <li><a href="#">Zapatillas Casual</a></li>
                            <li><a href="#">Zapatillas Deportivas</a></li>
                            <li><a href="#">Zapatillas de Correr</a></li>
